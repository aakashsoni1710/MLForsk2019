...
order_list=[item[0] for item in data]
cost=[product[3]*product[4] if product[3]*product[4]>100 else product[3]*product[4]+10 for product in data]
book_list=list(zip(order_list,cost))
print(book_list)
